export const APPS: any = [
  {
    ...
    hostingUrl: "https://bit.ly/3ufQrjB"
  },
{
    iconUrl: "./assets/dictionary-app.jpg",
    description: "I created this React Dictionary App thanks to the workshops",
    description2: "It's a simple search engine which uses API from",
...
},
{
    ...
    description: "I made this React Weather App thanks to the workshops",
    description2: "It's a daily forecast with the search engine which uses API from",
    descriptionUrl: "https://www.shecodes.io",
    descriptionUrlTitle: "SheCodes.io.",
